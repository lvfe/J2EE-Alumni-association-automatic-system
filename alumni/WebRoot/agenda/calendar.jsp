...
MeetingDAO meetingDao=new MeetingDAO();
    ...
    if ("add".equals(action)) {    
        ...
        task.setState(request.getParameter("state"));
         %>
    <%      
        out.print(meetingDao.addTask(task));
      ...
      System.out.println("22222");
        ...
        System.out.println(month+"000000"+year);
        List<Task> list=(List<Task>)meetingDao.getTasks(year,month);
