...
<html>
  <head>
	...
	<link href="<%=basePath%>css/index1.css" rel="stylesheet">
...
<table  width="100%" border="0" align="center" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="80%" valign="top" style="padding:5px;"><table width="98%" height="auto"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="22" valign="top" class="word_orange">当前位置：日程管理 &gt; 查看个人日程&gt;&gt;&gt;</td>
      </tr>
      <tr>
...
int d=cal.get(Calendar.DATE);     
    ...
    List<Task> listT=agendaDao.listTask();
  ...
  <tr align="center" bgcolor="#e3F4F7">
    ...
    <tr>
		<td class="td">
			<a href="javascript:void();"><%=task.getSubject()%></a></td>
			<td class="td">
