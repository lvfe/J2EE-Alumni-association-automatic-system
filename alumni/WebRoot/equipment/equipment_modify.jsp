...
<%@ page import="com.alumni.struts.form.EquipmentForm"%>
...
<table  width="80%" border="0" align="center" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="510" valign="top" style="padding:5px;"><table width="98%" height="504"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="39" valign="top" class="word_orange">当前位置：设备管理 &gt; 修改设备信息 &gt;&gt;&gt;</td>
      </tr>
      <tr>
        <td align="center" valign="top"><table width="68%"  border="0" cellpadding="0" cellspacing="0">
		<form name="form1" action="<%=basePath %>equipment.do?action=equipmentModify" method="post" onSubmit="return checkform(form1)">
		<%if(list.size()==1){
		EquipmentForm c=(EquipmentForm)list.get(0);
		%>
            <tr>
              <td width="20%" height="27" align="center">设备全称：</td>
              <td width="80%"><input name="ename" type="text" id="ename" value="<%=c.getEname()%>" size="30">
                *
                  <input name="id" type="hidden" id="id" value="<%=c.getId()%>"></td>
            </tr>
            <tr>
              <td height="27" align="center">类&nbsp;&nbsp;&nbsp;&nbsp;型：</td>
              <td><input name="etype" type="text" id="etype" size="30"  value="<%=c.getEtype()%>">
                *</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><input name="buy_time" type="text" id="buy_time" size="30" value="<%=c.getBuy_time() %>" onfocus="setday(this)">
                *</td>
            </tr>
			<%}else{%>
				<script language="javascript">
