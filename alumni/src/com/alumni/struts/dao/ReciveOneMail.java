...
public class ReciveOneMail {   
     ...
     * PraseMimeMessage类测试  
     */  
    public static List<ReciveOneMail> test(String user,String pass) throws Exception {
...
Session session = Session.getInstance(props);
       ...
       URLName urln = new URLName("pop3", "172.16.1.8", 110, null,user, pass);  
       // store.connect();  
        ...
        for (int i = 0; i < message.length; i++) { 
            ...
            System.out.println("Message " + i + " subject: " + pmm.getSubject());  
	           pmm.setDateFormat("yy年MM月dd日 HH:mm");  
	            ...
	            pmm.setPart((Part) message[i]);
	            pmm.getMailContent((Part) message[i]);  
	            System.out.println("Message " + i + " bodycontent: \r\n"  
	                    + pmm.getBodyText());
	            pmm.setAttachPath("d:\\forder\\");   
